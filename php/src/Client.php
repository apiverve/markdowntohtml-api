...
namespace APIVerve\Markdowntohtml;
 ...
 * ```
 *
 * @see https://markdowntohtml.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/markdowntohtml';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MarkdowntohtmlClient] {$message}\n";
        }
    }
}
