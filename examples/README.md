# Markdown to HTML API - Examples

This folder contains example code for using the Markdown to HTML API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/markdowntohtml',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/markdowntohtml");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/markdowntohtml](https://docs.apiverve.com/ref/markdowntohtml)
