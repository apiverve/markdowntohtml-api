...
namespace APIVerve.API.MarkdowntoHTML
{
    ...
    /// <summary>
    /// Client for the MarkdowntoHTML API
    /// </summary>
    public class MarkdowntoHTMLAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/markdowntohtml";
        ...
        public MarkdowntoHTMLAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MarkdowntoHTMLAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MarkdowntoHTMLAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MarkdowntoHTMLQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MarkdowntoHTMLQueryOptions options)
        {
        ...
        public ResponseObj Execute(MarkdowntoHTMLQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MarkdowntoHTMLQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MarkdowntoHTMLQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MarkdowntoHTMLQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MarkdowntoHTMLQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MarkdowntoHTMLQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MarkdowntoHTMLQueryOptions options)
        {
