...
```gradle
dependencies {
    implementation 'com.github.apiverve:markdowntohtml-api:1.1.12'
}
```
...
```java
import com.apiverve.markdowntohtml.MarkdowntoHTMLAPIClient;
import com.apiverve.markdowntohtml.APIResponse;
import com.apiverve.markdowntohtml.APIException;

// Initialize the client
MarkdowntoHTMLAPIClient client = new MarkdowntoHTMLAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/markdowntohtml](https://docs.apiverve.com/ref/markdowntohtml)
...
- **Documentation:** [https://docs.apiverve.com/ref/markdowntohtml](https://docs.apiverve.com/ref/markdowntohtml)
- **Issues:** [GitHub Issues](https://github.com/apiverve/markdowntohtml-api/issues)
